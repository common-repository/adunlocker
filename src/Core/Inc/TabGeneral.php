...
final class TabGeneral extends Tab {
     ...
     *
     */
    public function do_settings( string $tab_slug ) {
	...
	public function add_settings( $tab_slug ) {
        ...
        $group = 'AdUnlocker' . $tab_slug . 'OptionsGroup';
        $section = 'pp_AdUnlocker_' . $tab_slug . '_page_status_section';
	...
	public function create_field( $args = [] ) {
        ...
        if ( ! is_callable( [ $this, 'render_' . $args[ 'type' ] ] ) ) {
            ?><div class="ppc-system-warn"><?php esc_html_e( 'Handler for this field type not found.' ); ?></div><?php
            return;
        }
    ...
    public function render_divider( $key, $tab_slug ) {
	    ?><hr class="ppc-filed-divider"><?php
    }
    ...
    public function render_editor( $key, $tab_slug ) {
        ...
        if ( $description ) {
            ...
            <div class="ppc-text-field-helper-line">
                <div class="ppc-text-field-helper-text ppc-text-field-helper-text--persistent"><?php echo wp_kses_post( $description ); ?></div>
            </div>
            <?php
        }
    ...
    private function prepare_attr( $key, $tab_slug, $field ) {
        ...
        $name = 'pp_AdUnlocker_' . $tab_slug . '_settings';
