...
final class Plugin {
    ...
    private function initialization() {
        ...
        /** Full path to main plugin file. */
        self::$plugin_file = dirname( dirname( dirname( __DIR__ ) ) ) . '/adunlocker.php';
        ...
        if ( 'elementor' === self::$type ) {
            ...
            self::$menu_bases[] = 'elementor_page_pp_AdUnlocker_settings';
            self::$menu_bases[] = 'settings_page_pp_AdUnlocker_settings';

        /** For general WordPress plugins. */
        } else {

            self::$menu_bases[] = 'toplevel_page_pp_AdUnlocker_settings';
            self::$menu_bases[] = 'AdUnlocker_page_pp_AdUnlocker_settings';
    ...
    private function add_general_tab() {
        ...
        self::$tabs['general'] = [
            ...
            'label'         => esc_html__( 'General', 'AdUnlocker' ),
            'title'         => esc_html__( 'General Settings', 'AdUnlocker' ),
            'show_title'    => true,
            'icon'          => 'settings',
            'fields'        => []
        ];
    ...
    private function add_custom_css_tab() {
        ...
        self::$tabs['custom_css'] = [
            ...
            'label'         => esc_html__( 'Custom CSS', 'AdUnlocker' ),
            'title'         => esc_html__( 'Custom CSS', 'AdUnlocker' ),
            'show_title'    => true,
            'icon'          => 'code',
            'fields'        => [
                'custom_css' => [
                    'type'              => 'css_editor',
                    'description'       => esc_html__( 'Add custom CSS here.', 'AdUnlocker' ),
    ...
    private function add_assignments_tab() {
        ...
        self::$tabs['assignments'] = [
            ...
            'label'         => esc_html__( 'Assignments', 'AdUnlocker' ),
            'title'         => esc_html__( 'Assignments Settings', 'AdUnlocker' ),
            'show_title'    => true,
            'icon'          => 'beenhere',
            'assignments'   => [
    ...
    private function add_status_tab() {
        ...
        self::$tabs['status'] = [
            ...
            'label'         => esc_html__( 'Status', 'AdUnlocker' ),
            'title'         => esc_html__( 'System Status', 'AdUnlocker' ),
            'show_title'    => true,
            'icon'          => 'info',
            'reports'       => [
                'server'    => [
    ...
    private function add_uninstall_tab() {
        ...
        self::$tabs['uninstall'] = [
            ...
            'label'         => esc_html__( 'Uninstall', 'AdUnlocker' ),
            'title'         => esc_html__( 'Uninstall Settings', 'AdUnlocker' ),
            'show_title'    => true,
            'icon'          => 'delete',
            'fields'        => [
                'delete_plugin' => [
                    'type'              => 'select',
                    'options'           => [
                        'plugin'                => esc_html__( 'Delete plugin only', 'AdUnlocker' ),
                        'plugin+settings'       => esc_html__( 'Delete plugin and settings', 'AdUnlocker' ),
                        'plugin+settings+data'  => esc_html__( 'Delete plugin, settings and data', 'AdUnlocker' ),
                    ],
                    'default'           => 'plugin',
                ]
            ]
    ...
    public static function get_plugin_file() {
        ...
        return dirname( dirname( dirname( __DIR__ ) ) ) . '/adunlocker.php';
