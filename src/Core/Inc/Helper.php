...
final class Helper {
	...
	public function get_remote( $url ) {
		...
		$args = [
			'timeout'    => 30,
			'user-agent' => 'AdUnlocker-user-agent',
		];
    ...
    public function get_inline_svg( $icon ) {
        ...
        /** If icon from library. */
            ...
            $icon = Plugin::get_path() . 'images/ppc-icons/' . $icon;
        }
	...
	public function get_cpt( array $cpt ) {
		 ...
		 **/
		$post_types_objects = apply_filters( 'AdUnlocker/post_type_objects', $post_types_objects );
