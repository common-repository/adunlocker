...
use Core\AdUnlocker\Inc\AdUnlocker_elementor;
use Core\AdUnlocker\Inc\Plugin as UnityPlugin;
...
class ElementorControls extends AdUnlocker_elementor {
	 ...
	 *
	 */
	public function Group_Controls_Transform( string $section, string $prefix, string $selector, array $defaults = [], array $props = [], array $condition = [] ) {
	 ...
	 **/
	public static function get_instance(): ElementorControls {
